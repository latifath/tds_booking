<div class="col-md-8 offset-sm-2 booking-form">
    <form action="{{ route('root_hotel_search') }}">
        ...
        box-shadow: 0px 8px 79px 0px rgb(0 0 0 / 8%); z-index: 5;">
            <div class="check-date mr-3">
                ...
                <div class="boking-location" style="border-block-color: #e9ca1d00">
                    <input class="location-input" id="date-in" name="lieu" type="text"/>
            ...
            <div class="check-date mr-3">
                ...
                <div class="boking-datepicker" style="border-block-color: #e9ca1d00">
                    <input class="input-a" id="date-in" type="date" name="arriv_date" placeholder="10/12/2020"/>
                    <i class=""></i>
                </div>
            </div>
            <div class="check-date mr-3">
                ...
                <div class="boking-datepicker">
                    <input class="input-a" id="date-out" type="date" name="depart_date" placeholder="12/12/2020"/>
                    <i class="t"></i>
                </div>
            </div>
            ...
            <div class="select-optionx mr-3">
                <div class="boking-tittle">
                    <span class="adulte-span">Enfants:</span>
                </div>
                <div class="select-option">
            ...
            <div class="mr-3 ">
                <button class="bk-btn mb-0 px-3" type="submit" style="{{ couleur_background_2() }}; {{ text_color() }}">Rechercher</button>
            </div>
        </div>
    </form>
</div>
